...
public class WmSensitiveServiceImpl extends ServiceImpl<WmSensitiveMapper,WmSensitive> implements WmSensitiveService {
     ...
     */
    @Override
    public ResponseResult<Object> list(SensitiveDto dto) {
        //1.检查参数
        if(dto == null){
     ...
     */
    @Override
    public ResponseResult<Object> insert(WmSensitive wmSensitive) {
        //1.检查参数
        if(null == wmSensitive){
            return ResponseResult.errorResult(AppHttpCodeEnum.PARAM_INVALID);
        }
     ...
     */
    @Override
    public ResponseResult<Object> update(WmSensitive wmSensitive) {
        //1.检查参数
