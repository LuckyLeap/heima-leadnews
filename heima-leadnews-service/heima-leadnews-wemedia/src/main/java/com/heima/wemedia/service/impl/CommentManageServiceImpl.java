...
public class CommentManageServiceImpl implements CommentManageService {
     ...
     */
    @Override
    public ResponseResult<Object> updateCommentStatus(CommentConfigDto dto) {
     ...
     */
    @Override
    public ResponseResult<Object> list(CommentManageDto dto) {
     ...
     */
    @Override
    public ResponseResult<Object> delComment(String commentId) {
     ...
     */
    @Override
    public ResponseResult<Object> delCommentRepay(String commentRepayId) {
     ...
     */
    @Override
    public ResponseResult<Object> saveCommentRepay(CommentRepaySaveDto dto) {
        //1.检查参数
