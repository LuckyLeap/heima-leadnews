...
public class WmStatisticsServiceImpl implements WmStatisticsService {
     ...
     */
    @Override
    public ResponseResult<Object> newsDimension(String beginDate, String endDate) {
        ...
        //点赞数量&收藏数量
        ResponseResult<Object> responseResult = articleClient.queryLikesAndConllections(user.getId(), beginDateTime, endDateTime);
    ...
    public PageResponseResult newsPage(StatisticsDto dto) {
        ...
        return articleClient.newPage(dto);
    }
}