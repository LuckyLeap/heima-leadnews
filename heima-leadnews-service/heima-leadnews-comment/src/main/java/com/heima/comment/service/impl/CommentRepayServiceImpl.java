...
public class CommentRepayServiceImpl implements CommentRepayService {
    ...
    @Autowired
    public void setUserClient(IUserClient userClient, MongoTemplate mongoTemplate) {
        this.userClient = userClient;
        this.mongoTemplate = mongoTemplate;
    }

    @Override
    public ResponseResult<Object> loadCommentRepay(CommentRepayDto dto) {
        //1.检查参数
    ...
    @Override
    public ResponseResult<Object> saveCommentRepayLike(CommentRepayLikeDto dto) {
        //1.检查参数
