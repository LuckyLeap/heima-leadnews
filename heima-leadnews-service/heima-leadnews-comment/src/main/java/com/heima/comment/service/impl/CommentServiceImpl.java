...
public class CommentServiceImpl implements CommentService {
    ...
    @Autowired
    public void setUserClient(IUserClient userClient, MongoTemplate mongoTemplate, IArticleClient articleClient, RabbitTemplate rabbitTemplate) {
    ...
    @Override
    public ResponseResult<Object> saveComment(CommentSaveDto dto) {
        //1.检查参数
    ...
    private boolean checkParam(Long articleId) {
        //是否可以评论
        ResponseResult<Object> configResult = articleClient.findArticleConfigByArticleId(articleId);
    ...
    @Override
    public ResponseResult<Object> like(CommentLikeDto dto) {
        //1.检查参数
    ...
    @Override
    public ResponseResult<Object> findByArticleId(CommentDto dto) {
        //1.检查参数
