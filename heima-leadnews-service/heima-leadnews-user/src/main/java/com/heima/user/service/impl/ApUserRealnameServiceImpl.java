...
import com.heima.model.common.constants.UserConstants;
...
public class ApUserRealnameServiceImpl extends ServiceImpl<ApUserRealnameMapper, ApUserRealname> implements ApUserRealnameService {
    ...
    @Override
    public ResponseResult<Object> loadListByStatus(AuthDto dto) {
        //1.检查参数
        if(dto == null){
    ...
    @Override
    public ResponseResult<Object> updateStatus(AuthDto dto, Short status) {
        //1.检查参数
        ...
        if(status.equals(UserConstants.PASS_AUTH)){
            ResponseResult<Object> responseResult = createWmUserAndAuthor(dto);
    ...
    @Autowired
    public void setWemediaClient(IWemediaClient wemediaClient, ApUserMapper apUserMapper) {
     ...
     * 创建自媒体账户
     */
    private ResponseResult<Object> createWmUserAndAuthor(AuthDto dto) {
