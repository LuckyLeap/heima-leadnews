...
public class DESUtils {
    ...
    public static String encode(String pass){
        return byteToHexString(Objects.requireNonNull(encrypt(pass.getBytes(), key.getBytes())));
    }
    ...
    public static String decode(String passcode){
        return byteToHexString(Objects.requireNonNull(decrypt(hexToByteArr(passcode), key.getBytes())));
    }
